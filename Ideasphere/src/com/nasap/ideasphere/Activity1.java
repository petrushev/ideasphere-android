	...
	private ListView listviewnull;
	 ...
	 private String lv_arr[]={"Problems & Solutions [TAP]"};
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.fragment_activity1);
	        
	       
	      
	        listviewnull=(ListView)findViewById(R.id.listViewThird);
	      ...
	      public void onItemClick(AdapterView<?> parent, View view,
	          ...
	          switch (position) {
	            case 0:
	             Intent newActivity0 = new Intent(Activity1.this,Problem1.class);     
